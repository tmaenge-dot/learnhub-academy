  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        name: 'Touch Typing',
        icon: '⌨️',
        description: 'Professional typing skills for workplace efficiency',
        lessonCount: 30,
        resourceCount: 60,
      },
      {
        ...
        name: 'Office Skills',
        icon: '📊',
        description: 'Microsoft Office, Google Workspace, and business tools',
        lessonCount: 55,
        resourceCount: 130,
      },
      {
        ...
        icon: '🌐',
        description: 'Build websites and web applications professionally',
        lessonCount: 75,
        resourceCount: 170,
      },
    ],
