    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          {/* Advertisement - Top of Apps Section */}
          <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Shorthand Simplified App - NEW */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-6 text-white">
                <div className="text-6xl mb-3">🤖</div>
                <h3 className="text-2xl font-bold">Shorthand Simplified</h3>
              ...
              <div className="p-6">
                <p className="text-gray-700 mb-4">
                  AI-powered shorthand learning with instant stroke recognition. Get real-time feedback and master Pitman shorthand faster.
                </p>
                <ul className="text-gray-600 mb-6 space-y-2">
                  <li>✨ AI stroke recognition</li>
                  <li>✓ Interactive lessons</li>
                  <li>✓ Instant feedback</li>
                  <li>✓ Reference materials</li>
                </ul>
                <a
                  href="https://tmaenge-dot.github.io/learnhub-academy/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block text-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-pink-700 transition-colors"
                >
                  Open App
                </a>
              </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              <div className="text-sm text-cyan-600 font-semibold mb-2">December 2025</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                AI-Powered Shorthand App Launched
              </h3>
              <p className="text-gray-600 mb-4">
                We've launched Shorthand Simplified with AI stroke recognition technology for instant feedback and smarter learning.
              </p>
          ...
          {/* Advertisement - After News Section */}
          <div className="mt-12">
